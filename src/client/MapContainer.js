...
var MapContainer = function (layerView, mapId) {
    ...
    var mapGenerator = this.map.layer.mapGenerator;
    if (mapGenerator instanceof CityGenerator) {
        // scroll to city:
        this.scrollToCoordinates(-mapGenerator.cityPosX_renderCoord * 2, -mapGenerator.cityPosY_renderCoord);
    }
}
...
MapContainer.prototype.scrollToCoordinates = function (x, y) {
    ...
    var groundDragScaling = this.map.mapType.groundDragScaling;
    this.bgImageContainer.x = groundDragScaling * this.mainContainer.x;
    this.bgImageContainer.y = groundDragScaling * this.mainContainer.y;
};
